...
class Product
{
    ...
    /**
     * @var \Suppliercheck\AdminBundle\Entity\Campaign
     */
    private $campaign;
  ...
  public function setLink($link)
   ...
   //     	http://static.westwing.fr/i/8471/FR-CT761WWAQT17FR-1-newproduct.jpg
     ...
     * Set campaign
     *
     * @param \Suppliercheck\AdminBundle\Entity\Campaign $campaign
     * @return Product
     */
    public function setCampaign(\Suppliercheck\AdminBundle\Entity\Campaign $campaign = null)
    {
     ...
     * Get campaign
     *
     * @return \Suppliercheck\AdminBundle\Entity\Campaign 
     */
    ...
    {
//     	return ($this->supplierIdentifier . ' ' . $this->price);
		return ($this->sku);
    }
//     /**
//      * @var \Suppliercheck\AdminBundle\Entity\Campaign
...
//      * Set products
//      *
//      * @param \Suppliercheck\AdminBundle\Entity\Campaign $products
//      * @return Product
//      */
//     public function setProducts(\Suppliercheck\AdminBundle\Entity\Comment $products = null)
//     {
...
//     }
    ...
    /**
     * @var \Suppliercheck\AdminBundle\Entity\Comment
     *@ORM\OneToOne(targetEntity="Comment", mappedBy="product")
     */
     ...
     * Set comments
     *
     * @param \Suppliercheck\AdminBundle\Entity\Comment $comments
     * @return Product
     */
    public function setComments(\Suppliercheck\AdminBundle\Entity\Comment $comments = null)
    {
     ...
     * Get comments
     *
     * @return \Suppliercheck\AdminBundle\Entity\Comment 
     */
     ...
     * @return Product
     */
    public function addComment(\Suppliercheck\AdminBundle\Entity\Comment $comments)
    {
        $this->comments[] = $comments;
     ...
     * @param \Suppliercheck\AdminBundle\Entity\Comment $comments
     */
    public function removeComment(\Suppliercheck\AdminBundle\Entity\Comment $comments)
    {
     ...
     * Set product_comment
     *
     * @param \Suppliercheck\AdminBundle\Entity\Comment $productComment
     * @return Product
     */
    public function setProductComment(\Suppliercheck\AdminBundle\Entity\Comment $productComment = null)
    {
